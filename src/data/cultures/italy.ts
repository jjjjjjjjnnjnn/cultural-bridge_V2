...
export const italy: Culture = {
  ...
  food: [
    { name: { en: 'Pizza', zh: '披萨' }, desc: { en: 'Oven-baked flat bread with toppings', zh: '烤制的配料扁面包' }, emoji: '🍕', img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/Pizza.jpg/320px-Pizza.jpg' },
    { name: { en: 'Pasta', zh: '意大利面' }, desc: { en: 'Italian noodles in various shapes', zh: '各种形状的意大利面' }, emoji: '🍝', img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/Pasta.jpg/320px-Pasta.jpg' },
    { name: { en: 'Gelato', zh: '意式冰淇淋' }, desc: { en: 'Italian ice cream', zh: '意大利冰淇淋' }, emoji: '🍦', img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Gelato.jpg/320px-Gelato.jpg' },
  ],
  festivals: [
    { name: { en: 'Carnival of Venice', zh: '威尼斯狂欢节' }, desc: { en: 'Famous costume carnival', zh: '著名的变装狂欢节' }, emoji: '🎭', img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Carnival_of_Venice.jpg/320px-Carnival_of_Venice.jpg' },
    { name: { en: 'Scoppio del Carro', zh: '复活节烟花车' }, desc: { en: 'Easter fireworks tradition', zh: '复活节烟花传统' }, emoji: '🎆', img: '' },
  ],
  landmarks: [
    { name: { en: 'Colosseum', zh: '罗马斗兽场' }, img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/Colosseum_Rome.jpg/320px-Colosseum_Rome.jpg' },
    { name: { en: 'Leaning Tower of Pisa', zh: '比萨斜塔' }, img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/Leaning_Tower_of_Pisa.jpg/320px-Leaning_Tower_of_Pisa.jpg' },
    { name: { en: 'Venice Canals', zh: '威尼斯运河' }, img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Venice_canals.jpg/320px-Venice_canals.jpg' },
  ],
  etiquette: [
