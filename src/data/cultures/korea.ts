...
export const korea: Culture = {
  ...
  langCode: 'ko-KR',
  greetings: [
    { native: '안녕하세요', romanization: 'Annyeonghaseyo', meaning: { en: 'Hello', zh: '你好', de: 'Hallo' } },
    { native: '감사합니다', romanization: 'Gamsahamnida', meaning: { en: 'Thank you', zh: '谢谢', de: 'Danke' } },
    { native: '안녕히 계세요', romanization: 'Annyeonghi gyeseyo', meaning: { en: 'Goodbye', zh: '再见', de: 'Auf Wiedersehen' } },
  ],
  commonPhrases: [
    { native: '안녕하세요', romanization: 'Annyeonghaseyo', meaning: { en: 'Hello', zh: '你好', de: 'Hallo' } },
    { native: '감사합니다', romanization: 'Gamsahamnida', meaning: { en: 'Thank you', zh: '谢谢', de: 'Danke' } },
    { native: '안녕히 계세요', romanization: 'Annyeonghi gyeseyo', meaning: { en: 'Goodbye', zh: '再见', de: 'Auf Wiedersehen' } },
    { native: '죄송합니다', romanization: 'Joesonghamnida', meaning: { en: 'Sorry / Excuse me', zh: '对不起', de: 'Entschuldigung' } },
    { native: '네', romanization: 'Ne', meaning: { en: 'Yes', zh: '是的', de: 'Ja' } },
